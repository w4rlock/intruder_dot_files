...
export ZSH="/home/appsadm/.oh-my-zsh"
export PATH=$HOME/.local/bin:$PATH
export PATH=/opt/bin/apache-jmeter-3.2/bin:$PATH
export EDITOR=vim
...
PERL5LIB="/home/appsadm/perl5/lib/perl5${PERL5LIB:+:${PERL5LIB}}"; export PERL5LIB;
